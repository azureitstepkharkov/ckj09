    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            connection = DriverManager.getConnection(
                  //  "jdbc:oracle:thin:@localhost:1521:xe", "sysoper", "123");
                      "jdbc:oracle:thin:@localhost:1521:xe", "hr_copy", "hr");
...
//
    ...
    private static void callMyFunctForTest(Connection connection) {
        //callProcForTest(connection);
        System.out.println("call HR. ADD_AUTHORS");
        //Вызов ХП
        //КОМАНДЫ НА ODBC диалекте
        String sql = "{? = call HR. ADD_AUTHORS (?,?,?)}";
        //здесь аналог
        /*
        set SERVEROUTPUT ON
        declare
