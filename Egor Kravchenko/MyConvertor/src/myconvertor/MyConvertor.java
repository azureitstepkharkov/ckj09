...
public class MyConvertor {
    ...
    public static void main(String[] args) {
        ...
        jp2 = grRad.creat("градусы","радианы","convert",2);
        window.add(jp2);
        jp1.setLayout(new FlowLayout());
        
        Panell grFar = new Panell();
        JPanel jp3 = new JPanel();
        jp3 = grFar.creat("градусы","фаренгейты","convert",3);
        window.add(jp3);
        jp3.setLayout(new FlowLayout());
        
        Panell grKel = new Panell();
        JPanel jp4 = new JPanel();
        jp4 = grKel.creat("градусы","Кельвины","convert",4);
        window.add(jp4);
        jp4.setLayout(new FlowLayout());
         
        Panell farKel = new Panell();
        JPanel jp5 = new JPanel();
        jp5 = farKel.creat("Фаренгейты","Кельвины","convert",5);
        window.add(jp5);
